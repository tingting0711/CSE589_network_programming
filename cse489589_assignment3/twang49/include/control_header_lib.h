#ifndef _CONTROL_HANDLER_LIB_H_
#define _CONTROL_HANDLER_LIB_H_

#define CNTRL_HEADER_SIZE 8        // used in control_header_lib
#define CNTRL_RESP_HEADER_SIZE 8   // used in control_header_lib
#define CNTRL_RESP_ENTRY_SIZE 12   // used in routing_table
